...
<html> 
  ...
  <body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8"> 
            <div class="card">
                <div class="card-header" style="background-color:rgba(8,8,8,0.7);box-shadow: 1px 1px 20px rgb(0 0 0 / 50%); text-align: center;">{{ __('Reset Password') }}</div>
      ...
      <div class="row">
       ...
       <button id="btn_log" type="submit"> <div  class="col s6 right-align"><a class="waves-effect waves-light btn">  {{ __('Send Password Reset Link') }}</a></div></button>
      </div>
